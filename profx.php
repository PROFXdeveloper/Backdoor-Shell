<html><head><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
<style>

@import url('https://fonts.googleapis.com/css?family=Dosis');
@import url('https://fonts.googleapis.com/css?family=Bungee');
td,th,thead{border:1px solid #000;padding:5px;box-shadow:0 0 10px 0 #707070;}
tr{background-color:#fff;}
body{font-family:"Dosis",cursive;text-shadow:0px 0px 1px #707070;text-align:center;background-color:#f0f0f0;}
h1{text-align:center;}
form{display:flex;justify-content:center;align-items:center;gap:5px;}
.wrap{width:90%;margin:0 auto;text-align:left;display:table;margin-left:auto;margin-right:auto;}
table{margin:0 auto;border-collapse:collapse;width:100%;border:1px solid #000;}
thead tr{background-color:#ddd;font-weight:bold;}
td,th{border:1px solid #999;padding:8px;}
.textarea{width:90vw;height:70vh;resize:both;font-family:monospace;font-size:14px;display:block;margin:0 auto;}
.textinput{width:400px;}
.button-tools{margin:3px;}
